...
function Hero() {
  ...
  return (
    <section
      id="home"
      className="relative mx-auto max-w-[1440px] overflow-hidden px-5 pb-8 pt-[104px] sm:px-8 lg:flex lg:min-h-[calc(100vh-76px)] lg:items-center lg:px-12 lg:pb-8 lg:pt-24"
    >
      ...
      <div className="relative z-10 max-w-[890px]">
        <Reveal>
          <div className="mb-6 flex items-center gap-3 text-[11px] font-medium uppercase tracking-[0.2em] text-foreground/80 sm:text-[12px]">
            <span
        ...
        <Reveal>
          <p className="eyebrow mb-7 text-primary text-[15px] sm:text-[16px]">
        ...
        <Reveal delay="reveal-delay-2">
          <h1 className="mt-4 max-w-[920px] font-display text-[clamp(4rem,10vw,9.6rem)] leading-[.79] tracking-[-.045em] text-foreground">
            Intelligent
            <br />
        ...
        <Reveal
          ...
          className="mt-12 flex max-w-[680px] flex-col gap-7 sm:flex-row sm:items-end sm:justify-between"
        >
      ...
      <div
        className="hero-photo-card group relative z-30 pointer-events-auto mt-12 mx-auto h-[350px] w-[275px] sm:mt-16 sm:h-[410px] sm:w-[320px] lg:absolute lg:bottom-24 lg:right-16 lg:mt-0 lg:h-[500px] lg:w-[390px]"
        ...
        <div className="absolute -bottom-5 left-6 flex items-center gap-3 border border-primary/25 bg-background/90 px-4 py-2 shadow-[0_8px_25px_hsl(266_56%_25%_/_0.12)] backdrop-blur-md">
          ...
          <div>
            ...
            <div className="mt-0.5 flex items-center gap-1.5 font-mono-ui text-[8px] uppercase tracking-[.12em] text-muted-foreground">
              ...
              <Heart size={8} className="fill-violet-400 text-violet-400" />
            </div>
          </div>
        </div>
  ...
  return (
    <section id="about" className="bg-secondary/35">
      <div className="mx-auto max-w-[1440px] px-5 py-24 sm:px-8 lg:px-12 lg:py-28">
        <div className="grid gap-16 lg:grid-cols-[.8fr_1.7fr] lg:gap-24">
          <Reveal>
            <div>
              <p className="eyebrow mb-3 text-primary text-[0.82rem] sm:text-[0.9rem]">
                About
              </p>

              <h2
                className="mt-0 font-display text-[clamp(3.1rem,6vw,6.4rem)] leading-[.82] tracking-[-.035em]"
                data-testid="heading-about"
              >
                Let me introduce myself
              </h2>

              <div className="about-portrait group relative mt-8 flex aspect-[4/5] max-w-[340px] items-center justify-center overflow-hidden bg-transparent p-4">
          ...
          <Reveal delay="reveal-delay-1">
            <div>
              <p className="max-w-[770px] font-display text-[clamp(2.4rem,4.2vw,4.8rem)] leading-[.96] tracking-[-.025em] text-foreground">
                {profile.statement}
              </p>

              <p className="mt-10 max-w-[700px] text-[16px] leading-[1.75] text-muted-foreground">
                I’m Rabia Soomro, a Computer Systems Engineer working at the intersection of AI, data, and research.
              </p>

              <p className="mt-5 max-w-[700px] text-[16px] leading-[1.75] text-muted-foreground">
              ...
              <p className="mt-6 max-w-[700px] text-[14px] font-bold uppercase tracking-[0.18em] text-primary">
                Gold Medalist • Batch 2022
              </p>

              <div className="profile-details mt-12 grid max-w-[760px] sm:grid-cols-2">
                {info.map(([number, label, value]) => (
                  <div
                    key={label}
                    className="profile-detail-item group border-t border-border py-5 pr-6"
                  >
                    ...
                    <p className="mt-3 max-w-[280px] text-sm leading-[1.55] text-foreground/85 transition-transform duration-300 group-hover:translate-x-1">
                      {value}
                    </p>
                  </div>
                ))}
...
function Experience() {
  ...
  return (
    <section
      id="experience"
      className="mx-auto max-w-[1440px] px-5 py-24 sm:px-8 lg:px-12 lg:py-28"
    >
      <Reveal>
        <SectionHeading
          eyebrow="Experience"
      ...
      <div className="experience-main-card mt-14 rounded-2xl border-[1.5px] border-[#d8cde6] bg-[#ebe1f3] p-5 shadow-[0_18px_36px_hsl(266_56%_25%_/_0.06)] sm:p-7">
        <div className="grid grid-cols-[110px_1fr] gap-4 sm:grid-cols-[150px_1fr] sm:gap-6 lg:grid-cols-[220px_1fr] lg:gap-9">
          <div className="flex flex-col gap-2 sticky top-24 self-start">
            {experience.map((item, index) => (
              <button
                ...
                className={`w-full border-l-2 px-3 py-2.5 text-left text-xs sm:text-sm transition-colors ${
          ...
          {activeItem && (
            ...
            >
              ...
              <h3 className="mt-4 font-display text-[clamp(2rem,3vw,3.2rem)] leading-[.9]">
                {activeItem.role}
                <span className="text-primary"> @ {activeItem.organization}</span>
              </h3>

              <p className="mt-6 max-w-[760px] text-sm leading-[1.8] text-muted-foreground">
              ...
              {activeItem.recognition && (
                <span className="mt-6 inline-flex rounded-full border border-primary/25 bg-primary/5 px-3 py-2 font-mono-ui text-[10px] uppercase tracking-[.12em] text-primary">
                  {activeItem.recognition}
                </span>
              )}
            </article>
...
function SectionHeading({
  ...
  return (
    <div className="max-w-[760px]">
      ...
      <h2
        className="mt-0 font-display text-[clamp(3.8rem,7vw,7.6rem)] leading-[.8] tracking-[-.04em]"
        data-testid={testId}
      >
        {title}
      </h2>

      <p className="mt-10 max-w-[410px] text-sm leading-[1.7] text-muted-foreground sm:mt-12">
        {text}
      </p>
    </div>
  );
...
function ProjectCard({ project }: { project: Project }) {
  ...
  return (
    <article
      className="project-card flex h-[700px] w-[min(84vw,420px)] shrink-0 flex-col overflow-hidden"
    ...
    >
      ...
      <div className="flex flex-1 flex-col pt-6">
        ...
        <div className="mt-6 flex gap-5 overflow-x-auto overflow-y-hidden border-b border-background/20 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
          {project.details.map((detail, index) => (
            <button
              key={detail.title}
              type="button"
              onClick={() => setActiveDetail(index)}
              className={`relative shrink-0 pb-3 text-xs transition-colors ${
                activeDetail === index
                  ? 'text-accent'
        ...
        <div className="min-h-[132px] pt-6">
        ...
        <DotSeparatedTags
          ...
          className="mt-auto pt-6 text-background/70"
        />
...
function Projects() {
  return (
    <section id="work" className="bg-foreground text-background">
      <div className="mx-auto max-w-[1440px] px-5 py-24 sm:px-8 lg:px-12 lg:py-28">
        <Reveal>
          <div className="flex flex-col justify-between gap-8 border-b border-background/20 pb-10 sm:flex-row sm:items-end">
            <div className="max-w-[760px]">
              <p className="eyebrow text-accent">Projects</p>

              <h2 className="mt-7 font-display text-[clamp(4rem,7vw,8rem)] leading-[.8] tracking-[-.04em]">
                Things I&apos;ve built along the way.
              </h2>

              <p className="mt-6 max-w-[620px] text-sm leading-[1.7] text-background/70">
                A collection of systems, applications, experiments, and technical projects across AI, software, systems, robotics, and embedded technology.
              </p>
            </div>
          </div>
        </Reveal>

        <div className="project-carousel mt-10 overflow-x-auto overflow-y-hidden pb-4">
          <div className="flex min-w-max gap-6 lg:gap-8">
...
function Research() {
  ...
  return (
    ...
    >
      ...
      <div className="mt-14">
        <div className="overflow-x-auto pb-3 [scrollbar-width:thin] [scrollbar-color:rgba(103,74,165,0.35)_transparent]">
          <div className="flex min-w-max gap-6">
            {allResearch.map((item) => (
              <article
                key={item.id}
                className="glass-card flex h-[920px] w-[min(88vw,520px)] shrink-0 flex-col p-6 sm:p-7"
                data-testid={`item-research-${item.id}`}
              >
                <div className="flex items-center justify-between gap-4">
                  <span className="inline-flex border border-primary bg-primary px-4 py-2 font-mono-ui text-[10px] uppercase tracking-[.12em] text-primary-foreground">
                    {item.status}
                  </span>
                ...
                <h3 className="mt-5 min-h-[8.4rem] font-display text-[clamp(1.8rem,2vw,2.5rem)] leading-[1.08] tracking-[-0.03em]">
                  {item.title}
                </h3>
                ...
                <div className="mt-auto flex w-full flex-wrap gap-3 pt-7">
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1440px] px-5 py-24 sm:px-8 lg:px-12 lg:py-28">
        ...
        <div className="skills-main-card mt-12 rounded-2xl border-[1.5px] border-[#d8cde6] bg-[#ebe1f3] p-6 shadow-[0_18px_36px_hsl(266_56%_25%_/_0.06)] sm:p-8">
          <div className="space-y-7">
            {skillGroups.map((group) => (
              <div key={group.title}>
                <h3 className="mb-3 flex items-baseline gap-2 text-[15px] font-medium text-foreground">
...
function CertificationsSection() {
  ...
  const nextStep = () => {
    ...
    const firstCard = certTrackRef.current.querySelector<HTMLElement>('article');
  ...
  return (
    <section id="certifications" className="mx-auto max-w-[1440px] px-5 py-24 sm:px-8 lg:px-12 lg:py-28">
      <Reveal>
        <div className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
          ...
          <div className="flex gap-3">
            <button
              ...
              className="inline-flex h-11 w-11 items-center justify-center border border-border bg-background text-foreground transition-colors hover:border-primary hover:text-primary"
            >
              <ArrowLeft size={18} />
            </button>
            <button
      ...
      <div className="mt-10">
        ...
        <div
          ref={certTrackRef}
          className="cert-carousel overflow-x-auto pb-5 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden"
          ...
          onPointerUp={(event) => {
            ...
            const deltaX = touchStartXRef.current - event.clientX;
            if (Math.abs(deltaX) > 45) {
              scrollCerts(deltaX > 0 ? 'right' : 'left');
            }
                ...
                >
                  {cert.image && (
                    <div className="relative overflow-hidden border-b border-border bg-white/40">
                      <img
                        ...
                        className="h-52 w-full object-contain p-3 transition-transform duration-300 group-hover:scale-[1.02]"
                      />
                    </div>
                  )}
                  ...
                  <div className="flex flex-1 flex-col gap-4 p-5">
                    <div className="space-y-2">
                      ...
                      <h3 className="font-display text-[1.9rem] leading-[.95] tracking-[-.02em]">
                        {cert.title}
                      </h3>
                    </div>
                    ...
                    <div className="mt-auto pt-2">
                      {cert.credentialUrl && isUsableUrl(cert.credentialUrl) ? (
                        <a
...
function BeyondTheCode() {
  const [openEntry, setOpenEntry] = useState<string | null>(
    'Leadership & Impact-CSE Society'
  );

  const handleToggle = (entryKey: string) => {
    setOpenEntry((current) => (current === entryKey ? null : entryKey));
  };
      ...
      <div className="mx-auto max-w-[1440px] px-5 py-24 sm:px-8 lg:px-12 lg:py-28">
        <Reveal>
          <div className="max-w-[820px]">
            ...
            <h2 className="mt-0 font-display text-[clamp(2.2rem,4vw,4.3rem)] leading-[1.04] tracking-[-.03em] text-foreground">
              I build things. I lead people. I teach what I learn.
            </h2>
          </div>
        </Reveal>

        <div className="mt-10 w-full space-y-12">
          {beyondCodeCategories.map((category) => (
            <div key={category.title}>
              <p className="eyebrow mb-3 text-primary/80">
                {category.title}
              </p>

              <div className="grid w-full gap-3 md:grid-cols-2">
                {category.entries.map((entry) => {
                  const entryKey = `${category.title}-${entry.title}`;
                  ...
                  return (
                    <button
                      ...
                      className={`block h-full w-full rounded-xl border text-left transition-all duration-200 ${
                        isOpen
                    ...
                    >
                      <div className="flex items-start justify-between gap-4">
                        <div className="min-w-0">
                          <p className="font-display text-[1.4rem] leading-none tracking-[-.02em] text-foreground sm:text-[1.7rem]">
                            {entry.title}
                          </p>

                          <p className="mt-2 text-[0.72rem] uppercase tracking-[0.12em] text-primary/70">
                            {entry.meta}
                          </p>
                        </div>
                        ...
                        <div className="flex items-center gap-3">
                          {entry.title ===
                            'Sukkur IBA Student Council (SISC 2025)' && (
                            <span className="rounded-sm bg-primary px-2 py-1 font-mono-ui text-[9px] uppercase tracking-[0.12em] text-primary-foreground">
                              elected
                            </span>
                          )}
                      ...
                      >
                        <div className="overflow-hidden">
                          <div className="border-t border-primary/15 pt-4 text-sm leading-[1.7] text-muted-foreground">
                            {entry.details}
                          </div>
                        </div>
                      </div>
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      const payload = {
        ...
        subject: (new FormData(form).get('subject') ?? '').toString(),
        message: (new FormData(form).get('message') ?? '').toString(),
      };
        ...
        <Reveal>
          <div className="grid gap-16 lg:grid-cols-[1fr_1fr] lg:gap-28">
            <div>
              ...
              <h2
                className="mt-7 max-w-[700px] font-display text-[clamp(3.7rem,8vw,8.2rem)] leading-[.78] tracking-[-.04em]"
              ...
              <p className="mt-10 max-w-[410px] text-sm leading-[1.7] text-muted-foreground">
            ...
            <div className="contact-form-card p-6 sm:p-8">
              {sent ? (
                <div
                ...
                >
                  ...
                  <p className="mt-4 max-w-[350px] text-sm leading-[1.7] text-muted-foreground">
                    Thanks for reaching out. Your message has been sent through EmailJS.
                  </p>
